...
export const VerificationDashboard = () => {
  ...
  // NEW: State to hold the ETA calculated by the UploadZone
    ...
    pollingRef.current = setInterval(async () => {
      ...
      try {
        ...
        if (res.status === "indexed") {
          ...
          // SOTA: Fire Browser Notification!
  ...
  // NEW: Immediate Ingestion Trigger
  const handleIngestionStart = async (filename: string, eta: number) => {
