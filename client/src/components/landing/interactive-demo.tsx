...
import { 
  Search, Cpu, ShieldCheck, CheckCircle2, Loader2, CornerDownLeft, ArrowRight 
} from "lucide-react";
...
export function InteractiveDemo() {
  ...
  return (
    <div id="demo" className="w-full max-w-3xl mx-auto px-4 py-20 relative z-20">
      <div className="text-center mb-10 space-y-4">
        <h2 className="text-[10px] font-mono text-brand-primary uppercase tracking-[0.3em]">Live Simulation</h2>
        <h3 className="text-3xl font-bold text-white tracking-tight text-balance">Experience the Gating Logic</h3>
      </div>

      {/* REPLACED FLAT DIV WITH SKEUOCARD PHYSICS WRAPPER */}
      <SkeuoCard glowColor="rgba(14, 165, 233, 0.2)" className="bg-[#0d0d0d] p-0">
        ...
        <div className="p-8 min-h-[380px] flex flex-col relative z-10">
            ...
            {step === "idle" ? (
              ...
              >
                <div className="w-full max-w-md p-4 bg-black border border-white/10 rounded-2xl flex items-center justify-between group-hover:border-brand-primary/40 transition-colors shadow-inner">
                  ...
                  <button 
                    onClick={startDemo}
                    className="flex items-center gap-2 px-3 py-1.5 bg-brand-primary text-black text-[10px] font-black uppercase rounded-lg hover:bg-emerald-400 transition-all active:scale-95 shadow-[0_0_10px_rgba(16,185,129,0.3)]"
                  >
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className={cn("p-4 rounded-xl border border-white/5 bg-zinc-900/50 flex items-center gap-3 transition-opacity shadow-inner", progress < 40 && "opacity-30")}>
                  ...
                  <div className={cn("p-4 rounded-xl border border-white/5 bg-zinc-900/50 flex items-center gap-3 transition-opacity shadow-inner", progress < 80 && "opacity-30")}>
              ...
              >
                <div className="p-4 bg-brand-primary/10 border border-brand-primary/20 rounded-2xl flex items-center justify-between shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]">
                   ...
                   <span className="text-[10px] font-mono text-brand-primary bg-brand-primary/10 px-2 py-1 rounded">Confidence: 1.00</span>
                </div>
                <div className="font-mono text-sm text-zinc-300 leading-relaxed border-l-2 border-brand-primary/30 pl-6 py-2">
                  ...
                  <br/><br/>
                  <span className="text-zinc-600 text-[10px] uppercase">Source: ALPHABET_10K_2022.pdf • Page 47 • Line 12</span>
                </div>
        ...
        <div className="p-4 bg-black/50 border-t border-white/5 text-[9px] font-mono text-zinc-700 flex justify-between uppercase tracking-[0.2em] relative z-10">
