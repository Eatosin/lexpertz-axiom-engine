  ...
  return (
    <section id="architecture" className="relative py-32 px-6 max-w-7xl mx-auto z-20">
      ...
      >
        ...
        {/* CARD 1: Agentic Orchestration (Large) */}
        <motion.div variants={cardVariants} className="md:col-span-8 p-8 md:p-10 rounded-[32px] bg-surface border border-zinc-800 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05),0_15px_30px_rgba(0,0,0,0.6)] hover:border-brand-primary/40 hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_0_40px_rgba(16,185,129,0.15)] transition-all duration-500 group overflow-hidden relative">
          {/* Ambient Glow */}
          <div className="absolute top-0 right-0 w-96 h-96 bg-brand-primary/10 rounded-full blur-[100px] group-hover:bg-brand-primary/20 transition-colors duration-700 pointer-events-none" />
          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            <p className="text-zinc-400 text-base leading-relaxed max-w-lg mb-8">
              Axiom-Verify dismantles the black box. Your data doesn&apos;t just go to a chatbot; it is routed through four specialized LangGraph nodes: <strong className="text-zinc-200">Librarian, Editor, Architect, and Prosecutor.</strong>
            </p>
            ...
            <div className="mt-auto flex items-center gap-2 pt-6 border-t border-zinc-800/50">
               {["Retrieve", "Distill", "Reason", "Audit"].map((step, i) => (
                 <div key={i} className="flex items-center gap-2">
                   <div className="px-3 py-1.5 rounded-lg bg-[#0A0A0A] border border-zinc-800 text-[10px] font-mono text-zinc-500 uppercase tracking-widest shadow-inner group-hover:border-brand-primary/30 group-hover:text-brand-primary transition-colors delay-[0ms]">
                     {step}
                   </div>
        ...
        <motion.div variants={cardVariants} className="md:col-span-4 p-8 rounded-[32px] bg-surface border border-zinc-800 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05),0_15px_30px_rgba(0,0,0,0.6)] hover:border-brand-secondary/40 transition-all duration-500 group overflow-hidden relative">
          ...
          <h4 className="text-xl font-bold mb-3 text-white">Mathematical Auditing</h4>
          <p className="text-zinc-400 text-sm leading-relaxed">
            Every output is graded in real-time by an NVIDIA NIM Llama 3.3 Judge. Axiom delivers a live RAGAS telemetry score for <strong className="text-zinc-200">Faithfulness</strong>, ensuring 100% traceability.
          </p>
        ...
        <motion.div variants={cardVariants} className="md:col-span-4 p-8 rounded-[32px] bg-surface border border-zinc-800 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05),0_15px_30px_rgba(0,0,0,0.6)] hover:border-red-500/30 transition-all duration-500 group overflow-hidden relative">
          ...
          <h4 className="text-xl font-bold mb-3 text-white">Zero-Inference Gating</h4>
          <p className="text-zinc-400 text-sm leading-relaxed">
            If the evidence isn&apos;t in your Vault, Axiom won&apos;t invent it. The system is mathematically constrained by strict Pydantic logic to refuse answers outside the provided context.
          </p>
        </motion.div>

        {/* CARD 4: Hybrid Search & Citations (Large) */}
        <motion.div variants={cardVariants} className="md:col-span-8 p-8 md:p-10 rounded-[32px] bg-gradient-to-br from-brand-primary/10 to-[#0A0A0A] border border-brand-primary/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_20px_40px_rgba(0,0,0,0.5)] flex flex-col md:flex-row items-center gap-10 hover:shadow-[0_0_50px_rgba(16,185,129,0.1)] transition-shadow">
          <div className="space-y-6 flex-1">
            ...
            <p className="text-zinc-400 text-base leading-relaxed">
              Interrogate your entire vault simultaneously. We fuse 1024-D Vector Semantic Search with PostgreSQL Full-Text Keyword Search to find exact legal clauses across thousands of documents.
            </p>
          </div>
          ...
          <div className="shrink-0 w-40 h-48 rounded-2xl bg-[#111]/80 backdrop-blur-xl border border-zinc-700 shadow-[inset_0_2px_4px_rgba(255,255,255,0.1),0_15px_30px_rgba(0,0,0,0.8)] relative flex items-center justify-center transform rotate-3 hover:rotate-0 transition-transform duration-500">
             ...
             <div className="absolute bottom-4 left-4 right-4 h-2 bg-zinc-800 rounded-full overflow-hidden">
               <div className="w-[80%] h-full bg-brand-primary shadow-[0_0_10px_rgba(16,185,129,1)]" />
             </div>
          </div>
        </motion.div>
