      ...
      <AnimatePresence mode="wait">
        {!file ? (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="border-2 border-dashed border-white/10 rounded-3xl p-12 text-center transition-all cursor-pointer group hover:border-brand-primary/40 bg-white/5"
          ...
          >
            ...
            />
            <div className="h-16 w-16 bg-white/5 border border-white/10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 group-hover:bg-brand-primary/10 transition-all">
          ...
          >
            ...
            <button
              ...
              disabled={uploading}
              className="w-full py-4 bg-brand-primary text-black font-bold rounded-xl flex items-center justify-center gap-2 hover:shadow-[0_0_20px_rgba(16,185,129,0.3)] transition disabled:opacity-50"
            >
              {uploading ? (
